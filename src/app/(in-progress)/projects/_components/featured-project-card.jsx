...
function DetailedViewModal({ project, isOpen, onClose }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center p-4 sm:p-6 lg:p-8 pt-20 sm:pt-10 pb-8">
        <motion.div
        ...
        >
          ...
          <div className="relative bg-linear-to-b from-gray-900 to-gray-950 rounded-3xl border border-gray-800/80 shadow-2xl">
            ...
            <div className="p-6 sm:p-8 lg:p-12 space-y-6 sm:space-y-8">
              ...
              {/* Project Image */}
              <div className="relative h-48 sm:h-64 lg:h-80 rounded-2xl overflow-hidden border border-gray-800/50">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
              ...
              {/* Features Section */}
              <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-5 sm:p-6 border border-gray-700/50">
                <h4 className="text-lg sm:text-xl font-semibold text-gray-200 mb-4 flex items-center gap-2">
              ...
              {/* Challenges Section */}
              {project.challenges && (
                <div className="bg-linear-to-br from-purple-900/10 via-purple-800/5 to-pink-900/10 backdrop-blur-sm rounded-2xl p-5 sm:p-6 border border-purple-700/30">
                  <h4 className="text-lg sm:text-xl font-semibold text-gray-200 mb-3 flex items-center gap-2">
